      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'There is an error while logging out. Please try again.');
...
var displayMap = function displayMap(location) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // center: [-115.570154, 51.178456],
    // zoom: 5,
  ...
  location.forEach(function (el) {
    ...
    newElement.className = 'marker'; // Add Marker

    new mapboxgl.Marker({
      element: newElement,
      anchor: 'bottom'
    }).setLngLat(el.coordinates).addTo(map); // Add pop up description

    new mapboxgl.Popup({
      offset: 30,
      closeOnClick: false
    }).setLngLat(el.coordinates).setHTML("<p>Day ".concat(el.day, ": ").concat(el.description, "</p>")).addTo(map); // Extend map bound to include current locations
...
},{}],"updateAcctData.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"forgotResetPassword.js":[function(require,module,exports) {
"use strict";
...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(password, passwordConfirm) {
    var params, token, res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51IU6tBBuJmqItreCt9sIGmUb7vJPSWVb1NkmWNHHWjpQwNAeXIHxCJCGJpTddBrQ3gLdf3S0H7yU7Q0MXEDcCVqm00Z8PamZYl');
            _context.next = 4;
...
var _updateAcctData = require("./updateAcctData");

var _signup = require("./signup");

var _forgotResetPassword = require("./forgotResetPassword");
...
var logoutButton = document.querySelector('a.nav__el--logout');
var updateNameEmailBtn = document.getElementById('updateNameEmailBtn');
var updatePassBtn = document.getElementById('updatePassBtn');
var signupForm = document.getElementById('formSignup');
var forgotPasswordForm = document.getElementById('form-forgotPassword');
var resetPasswordForm = document.getElementById('formResetPassword');
var bookTourBtn = document.getElementById('book-tour');

if (mapBox) {
  var location1 = JSON.parse(mapBox.dataset.locations);
  (0, _mapbox.displayMap)(location1);
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 8;
              return (0, _updateAcctData.updateSettings)(form, 'Data');
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 7;
              return (0, _updateAcctData.updateSettings)({
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    var passwordConfirm = document.getElementById('signup-confirmPassword').value;
...
if (forgotPasswordForm) {
  forgotPasswordForm.addEventListener('submit', function (e) {
    ...
    (0, _forgotResetPassword.forgotPassword)(email);
  });
}
...
if (resetPasswordForm) {
  resetPasswordForm.addEventListener('submit', function (e) {
    ...
    var passwordConfirm = document.getElementById('reset-new-confirmPassword').value;
    (0, _forgotResetPassword.resetPassword)(password, passwordConfirm);
  });
}
